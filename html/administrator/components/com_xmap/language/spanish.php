 ...
 * @translator Guillermo Vargas
 */


defined( '_VALID_MOS' ) or die( 'No se permite el acceso directo a esta posición.' );
...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    define('_XMAP_CFG_INCLUDE_LINK',		'Vínculo al sitio del autor');
	...
	define('_XMAP_MSG_SET_DB_DROPPED',    'La tabla de opciones se ha respaldado!');
}
?>